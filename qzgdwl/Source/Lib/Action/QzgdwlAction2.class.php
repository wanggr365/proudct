...
class QzgdwlAction extends Action {
	...
	public function is_session(){
		/*if(!$_SESSION['own_org_id']){
			$url = " https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx3a20e613be177269&redirect_uri=http://wx.968816.com.cn/oauth2_openid_ywy.php&response_type=code&scope=snsapi_base&state=1#wechat_redirect";
			echo "<script>";  
