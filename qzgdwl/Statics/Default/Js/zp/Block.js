...
Block.prototype.end = function(){
	...
	currentAjax = $.ajax({
		...
		success: function(json){			
			...
			if(0<_t.money<60){  //modify  最后修改到60
				againMask.innerHTML =
				'<div id="gove" ><h2 id="againSum">抢到了'+_t.money+'积分</h2><h1>果然是大神附体!</h1><span style="display: initial;" onclick="againStart();"><img style="width:50%;" src="Statics/Default/Images/qhb/e2.png"></span><div>';
			}

			if(_t.money>=60){   //modify  最后修改到60
				againMask.innerHTML =
				'<div id="gove" ><h2 id="againSum">只抢了'+_t.money+'积分</h2><h1>难道是大神没附体？</h1><span style="display: initial;" onclick="goZpIndex();"><img style="width:50%;"  src="Statics/Default/Images/qhb/e1.png"></span><div>';
			}
			// setTimeout(function(){
...
//
//var goZpIndex = document.getElementById("goZpIndex");
function goZpIndex(){//玩转盘的机会+1
	window.location.href = "index.php?m=zp&a=zpIndex";
}
//游戏重来
