$(function(){
	document.getElementById('getVerCode').addEventListener('tap',function(){
        sendCode($("#getVerCode"));
    });
...
function sendCode(obj){
	...
	if(BASEtrim(phone.val()) == "" || BASEtrim(custName.val()) == "" || BASEtrim(custCode.val()) == "") {
		layer.open({
			btn: ['好的'],
		...
		if(result){
			doPostBack('index.php?m=qzgdwl&a=sendSMS',backFunc1,$('#login-form').serialize());			
		}
	}
}
